...
def nyt_api_response(date, nyt_api_key):
    """
...
df_bestsellers.to_csv(f'{path_output_csv}/nyt_bestsellers_books.csv', header=True, index=False, encoding='utf-8-sig',sep=';')
df_book_buy_link.to_csv(f'{path_output_csv}/nyt_buy_link_by_bestseller_book.csv', header=True, index=False, encoding='utf-8-sig',sep=';')
