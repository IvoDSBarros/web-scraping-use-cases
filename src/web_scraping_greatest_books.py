...
#==============================================================================
# To extract the list of the greatest books of all time (n=300) compiled on the
# website "thegreatestbooks.org". 
#==============================================================================
...
df_the_greatest_books.to_csv(f'{path_dir}/output/the_greatest_books_of_all_time.csv', header=True, index=False, encoding='utf-8-sig',sep=';')
